...
export const ProjectsSection = ({ onBack }: ProjectsSectionProps) => {
	return (
		<div className="h-dvh relative h-screen w-full overflow-x-hidden overflow-y-hidden">
			...
			<div className="relative z-10 h-full flex flex-col pt-8 pb-6">
				{/* Fixed Header */}
				<motion.div
				...
				>
					...
					<Heading className="font-black text-2xl md:text-3xl text-neutral-800 mb-2">Featured Projects</Heading>
						...
						<div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-stretch">
							{projects.map((project, index) => {
								...
								return (
									...
									>
										<div
											className={`relative bg-white rounded-2xl ${shadowClass} hover:shadow-xl transition-all duration-500 overflow-hidden border border-neutral-100 hover:border-neutral-200 h-full flex flex-col`}
										>
											...
											<div className="p-4 sm:p-6 flex-1 flex flex-col">
												<div className="mb-3">
													<Heading
														as="h3"
														className="text-base sm:text-lg font-bold text-neutral-800 group-hover:text-neutral-900 transition-colors"
													>
														{project.title}
													</Heading>
												</div>
