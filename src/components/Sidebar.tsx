			...
			<AnimatePresence>
				{open && (
					<motion.div
						...
						exit={{ x: -200 }}
						className="px-6  z-[100] py-10 bg-neutral-100 max-w-[14rem] lg:w-fit  fixed lg:relative  h-dvh left-0 flex flex-col justify-between"
					>
...
const SidebarHeader = () => {
	return (
		<div className="flex space-x-2">
			<Image src="/boy.png" alt="Avatar" height={30} width={30} className="object-cover rounded-full" />
			<div className="flex text-sm flex-col">
				<p className="font-bold text-primary">Prajwal More</p>
