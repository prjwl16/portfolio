...
export const projects: Product[] = [
	...
	},
	{
		...
		description:
			"A private emotional journaling app designed to help users track their mood, reflect on thoughts, and gain insights over time through clean, minimalist UI.",
		...
		content:
			"CalmLog provides a distraction-free space to record and revisit daily emotional experiences. Users can tag their entries, track mood trends, and visualize emotional shifts over time. Built with privacy in mind, it supports user authentication and secure Supabase backend.",
	},
	{
		title: "The Traitors Game",
		description:
			"An AI-enhanced multiplayer social deduction game inspired by 'The Traitors', designed for remote friend groups with live chat, whisper mechanics, and betrayal-driven gameplay.",
		...
		content:
			"Players are assigned secret roles like 'Traitor' or 'Faithful' and must survive by deduction and deception. Features include AI-generated missions, whisper chats, real-time voting, and admin tools for game hosting. Designed for high engagement and drama among remote teams or friends.",
	},
	{
		title: "SharePrompts",
		description:
			"A beautifully simple platform to share and discover ChatGPT prompts with preview support, making it easier to learn and showcase AI use cases.",
		...
		content:
			"Built as a playground for prompt engineering, this app allows users to upload and share their best ChatGPT prompts with beautiful formatting and metadata. It supports real-time previews, prompt categorization, and user authentication powered by Supabase Auth.",
	},
	{
		title: "FurniTrack ERP",
		description:
			"A lightweight ERP solution tailored for furniture businesses to manage inventory, orders, and production workflows efficiently from a single dashboard.",
		...
		content:
			"Built for small to mid-sized furniture businesses, this ERP system streamlines operations by offering modules for order management, inventory tracking, customer records, and delivery statuses. It's fast, mobile-friendly, and customizable for offline workflows.",
	},
];
